...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fancyapps/ui@4.0/dist/fancybox.css?_v=20211228184638" />
            ...
            <div class="main-photo__wrapper wrapper">
                ...
                <section class="main-photo__images images">
                    ...
                    <div class="images__items" id="fa">
                        ...
                        <a href="img/paralet/classic03.jpg" target="_blank" rel="noopener noreferrer"
                        ...
                        <a href="img/paralet/classic04.jpg" target="_blank" rel="noopener noreferrer"
                            title="посмотреть увеличенную фотографию">
                            <picture>
                        ...
                        <a href="img/paraplan/jambo.jpg" target="_blank" rel="noopener noreferrer"
                            title="посмотреть увеличенную фотографию">
                            <picture>
                        ...
                        <a href="img/paraplan/trike-2-color.jpg" target="_blank" rel="noopener noreferrer"
                            title="посмотреть увеличенную фотографию">
                            <picture>
                        ...
                        <a href="img/training.jpg" target="_blank" rel="noopener noreferrer"
                            title="посмотреть увеличенную фотографию">
                            <picture>
                        ...
                        <a href="img/paralet/double_paralet.jpg" target="_blank" rel="noopener noreferrer"
                            title="посмотреть увеличенную фотографию">
                            <picture>
                        ...
                        <a href="img/paraplan/trike-2.jpg" target="_blank" rel="noopener noreferrer"
                            title="посмотреть увеличенную фотографию">
                            <picture>
                        ...
                        <a href="img/paralet/patriot02.jpg" target="_blank" rel="noopener noreferrer"
                            title="посмотреть увеличенную фотографию">
                            <picture>
                        ...
                        <a href="img/paralet/patriot-2_04.jpg" target="_blank" rel="noopener noreferrer"
                            title="посмотреть увеличенную фотографию">
                            <picture>
                                <source srcset="img/paralet/patriot-2_04_mini.webp" type="image/webp">
                                <img src="img/paralet/patriot-2_04_mini.jpg" loading="lazy"
                                    alt="двухместный паралет синие сидушки желтые лопасти">
                            </picture>
                        </a>
                        <a href="img/paralet/patriot03.jpg" target="_blank" rel="noopener noreferrer"
                            title="посмотреть увеличенную фотографию">
                            <picture>
                        ...
                        <a href="img/paralet/patriot06.jpg" target="_blank" rel="noopener noreferrer"
                            title="посмотреть увеличенную фотографию">
                            <picture>
                                <source srcset="img/paralet/patriot06_mini.webp" type="image/webp">
                                <img src="img/paralet/patriot06_mini.jpg" loading="lazy"
                                    alt="двухместный паралет синие сидушки желтые лопасти">
                            </picture>
                        </a>
                    </div>
...
<script src="https://cdn.jsdelivr.net/npm/@fancyapps/ui@4.0/dist/fancybox.umd.js?_v=20211228184638"></script>
<script>
    Fancybox.bind("#fa a", {
        groupAll: true,
    });
