...
<body class="paraplan">
    ...
    (function (d, w, id) {
        ...
        <!-- Rating Mail.ru counter -->
        <header class="header paraplan__header">
        ...
        <main class="paraplan__main main-paraplan">
            <div class="main-paraplan__wrapper wrapper">
                <h1 class="main-paraplan__title _title">Парапланы на Paraplana.net</h1>
                <p class="main-paraplan__price">Цены на тандемные моторные крылья <span>от&nbsp;135&nbsp;000&nbsp;р.</span></p>

                <section class="main-paraplan__trike">
                    <h2 class="main-paraplan__sub-title _sub-title">
                        Новый моторный тандемный параплан TRIKE-2 площадью 39&nbsp;и&nbsp;42&nbsp;кв.м.
                    </h2>
                    ...
                    <div class="main-paraplan__links">
                        <a href="img/paraplan/trike-2.jpg" title="посмотреть увеличенную фотографию" target="_blank" rel="noopener noreferrer">
                            <picture>
                        ...
                        <a href="https://www.youtube.com/watch?v=fPkKYpyuBtk&t=28s" title="посмотреть видео на youtube" target="_blank" rel="noopener noreferrer">
                            <picture>
                    ...
                    <div class="main-paraplan__links">
                        <a href="img/paraplan/trike-2-color.jpg" title="посмотреть увеличенную фотографию" target="_blank" rel="noopener noreferrer">
                            <picture>
                                <source srcset="img/paraplan/trike-2-color_mini.webp" type="image/webp">
                                <img src="img/paraplan/trike-2-color_mini.jpg" alt="параплан трехцветный: бело-сине-красный">
                            </picture>
                        </a>
                        <a href="img/paraplan/trike-2-standart-color.jpg" title="посмотреть увеличенную фотографию" target="_blank" rel="noopener noreferrer">
                            <picture>
                                <source srcset="img/paraplan/trike-2-standart-color_mini.webp" type="image/webp">
                                <img src="img/paraplan/trike-2-standart-color_mini.jpg" alt="шесть парапланов с разными расцветками">
                            </picture>
                        </a>
                    </div>
                </section>
                <section class="main-paraplan__jambo">
                    ...
                    <div class="main-paraplan__links">
                        <a href="img/paraplan/jambo.jpg" title="посмотреть увеличенную фотографию" target="_blank" rel="noopener noreferrer">
                            <picture>
                        ...
                        <a href="https://www.youtube.com/watch?v=ComJWO0dJRI" title="посмотреть видео" target="_blank" rel="noopener noreferrer">
                            <picture>
        ...
        <footer class="footer paraplan__footer">
